...
/**
 * An interface for providing configurable properties to a JianpuRender.
 */
export interface JianpuRenderConfig {
...
export class StaffSVGRender {
  ...
  private config: JianpuRenderConfig;
   ...
   * altered by `JianpuRenderConfig.scrollType`.
